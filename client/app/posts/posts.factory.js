(function() {
  ...
  function factory ($http, env) {
    ...
    function addPost(post) {
      ...
      return $http.post('http://localhost:3000/api/posts', {post: post})
        .then(function (response) {
    ...
    function deletePost(postId) {
      return $http.post('http://localhost:3000/api/posts/delete', {postId: postId})
    }
    function voteClick(postId, vote) {
      return $http.post('http://localhost:3000/api/posts/vote', {postId: postId, vote: vote})
    }
